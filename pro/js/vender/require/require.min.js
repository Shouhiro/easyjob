  ...
  function commentReplace(e, t) {
    ...
    function t(e) {
      ...
      var a,
          ...
          f = e,
          l = !0,
          h = "";return e || (l = !1, e = "_@r" + (A += 1)), c = o(e), d = c[0], e = c[1], d && (d = i(d, p, n), s = getOwn(j, d)), e && (d ? h = s && s.normalize ? s.normalize(e, function (e) {
        return i(e, p, n);
      }) : e.indexOf("!") === -1 ? i(e, p, n) : e : (h = i(e, p, n), c = o(h), d = c[0], h = c[1], r = !0, a = q.nameToUrl(h))), u = !d || s || r ? "" : "_unnormalized" + (T += 1), { prefix: d, name: h, parentMap: t, unnormalized: !!u, url: a, originalName: f, isDefine: l, id: (d ? d + "!" + h : h) + u };
    }function s(e) {
      var t = e.id,
      ...
      var e;for (d(); O.length;) {
        ...
        R = {},
        A = 1,
        T = 1;return E = { require: function require(e) {
